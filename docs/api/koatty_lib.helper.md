...
[chmod(p, mode)](./koatty_lib.helper.chmod.md)
...
[isArray(value)](./koatty_lib.helper.isarray.md)
...
[isDir(p)](./koatty_lib.helper.isdir.md)
...
[isFile(p)](./koatty_lib.helper.isfile.md)
...
[readDir(p, filter, prefix)](./koatty_lib.helper.readdir.md)
...
[readFile(filename, enc)](./koatty_lib.helper.readfile.md)
...
[rmDir(p, reserve)](./koatty_lib.helper.rmdir.md)
...
[writeFile(filename, data)](./koatty_lib.helper.writefile.md)
